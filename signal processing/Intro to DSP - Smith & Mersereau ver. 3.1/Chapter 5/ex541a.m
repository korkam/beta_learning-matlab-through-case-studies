% Exercise 5.4.1.a. Sketching the Magnitude Response.
...
figure('Name','Exercise 5.4.1.a. Sketching Magnitude Response from Pole/Zero Plots');
subplot(1,2,1);
zplane(b,a);
title('H(z) = 1 -  0.5z^{-1}');
hold on

disp('Exercise 5.4.1.a: pole/zero plot - Hit any key to animate')
pause;
