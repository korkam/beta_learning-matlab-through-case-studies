% Exercise 5.4.2.b. Sketching Magnitude Responses from Pole/Zero Plots.
...
%% poles & zeros
pp = 1.5*exp(1i*pi);
zz  = [ 0.5*exp(1i*pi/2) 0.5*exp(- 1i*pi/2) ].';
[b,a] = zp2tf(zz,pp,1);

figure('Name','Exercise 5.4.2.b. Sketching Magnitude Response from Pole/Zero Plots');
subplot(1,2,1);
zplane(b,a);
title(['       (1 - 1/2e^{j\pi/2}z^{-1})(1 - 1/2e^{-j\pi/2}z^{-1})';
        'H_2(z) = ---------------------------------------------    ';        
        '                    1 - 3/2e^{j\pi}z^{-1}                 ';
        '                                                          ';
        '                                                          ';]);
...
disp('Exercise 5.4.2.b: pole/zero plot of H2(z) - Hit any key to animate')
pause
