% Exercise 5.4.2.a. Sketching Magnitude Responses from Pole/Zero Plots.
...
clear; colordef black; close all; clc;
...
figure('Name','Exercise 5.4.2.a. Sketching Magnitude Response from Pole/Zero Plots');
subplot(1,2,1);
zplane(b,a);
title('H_1(z) = (1 - z^{-1})/(1 - 1/2e^{j\pi}z^{-1})');
hold on

disp('Exercise 5.4.2.a.: pole/zero plot of H1(z) - Hit any key to animate')
pause
